        ...
        return (
            <div className={styles.mainBody}>
                <div className={`${styles.navitemContainer}`}>
                    <NavLink
                        to="/"
                        className={`${styles.twiiter} ${styles.navitem}`}
                    >
                        <div>
                            <svg
                    ...
                    <NavLink
                        to="/explore"
                        className={`${styles.explore} ${styles.navitem}`}
                    >
                        <svg
                            className={styles.svg}
                            viewBox="0 0 24 24"
                    ...
                    <NavLink
                        to="/setting"
                        className={`${styles.setting} ${styles.navitem}`}
                    >
                        <svg
                            className={styles.svg}
            ...
            <div className={styles.mainBody}>
                <div className={`${styles.navitemContainer}`}>
                    ...
                    >
                        ...
                        <p className="navbarText">Message</p>
                    </NavLink>
                    <NavLink
                    ...
                    >
                        ...
                        >
                            ...
                            <g id="SVGRepo_iconCarrier">
                                {" "}
                                <title>profile [#fffffffffff]</title>{" "}
