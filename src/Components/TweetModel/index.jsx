...
export default function TweetModel(props) {
    const [liked, setLiked] = useState(
        props.tweet.liked === null || props.tweet.liked === undefined
            ? false
            : true
    );
    ...
    function handleRetweetPress(ev,data){
        ev.stopPropagation();
        props.handleRetweetPress(data);
    }

    function handleCommentPress(ev,data){
        ev.stopPropagation();
        props.handleCommentPress(data);
    }
        ...
        <div onClick={()=>{navigate(`/tweet/${props.tweet.t_id}`)}}>
            <TweeterTextModel tweet={props.tweet} className={props.className}>
                <div className={Styles.btnCluster}>
                    ...
                    <button
                        onClick={(ev) =>handleRetweetPress(ev,props.tweet)}
                        className={`${Styles.button} ${Styles.retweetBtn}`}
                    >
                        <svg
                    ...
                    <button
                        ...
                        className={`${Styles.button} ${Styles.likeBtn}`}
                    >
                        <svg
